$(document).ready(function() {
	...
	$(".my-nav > div:first-child > div").on('mouseenter', function(){
		$('.my-nav > div:first-child > div > div:first-child').css("background","rgb(127, 174, 201)");
		$(this).children('div:first-child').css("background","rgb(99,154,197)");
	});
	$(".my-nav > div:first-child > div").on('mouseleave', function(){
		$(this).children('div:first-child').css("background","rgb(127, 174, 201)");
	});
});